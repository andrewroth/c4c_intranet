...
//	VARIABLES:
	...
	var $viewerID;				// The Viewer ID of this Page's viewer
	var $viewerLanguageID;		// The Language ID of this Page's Viewer
	var $viewerAccessLevel;		// The Access Level of this Page's Viewer.  This value is used
								// to determine what info this viewer is allowed to see on this
								// page.
	...
	var $Message;				// General Messages that need to be displayed to the Viewer.
