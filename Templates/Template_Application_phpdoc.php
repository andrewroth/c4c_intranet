...
// VARIABLES
//
/** STRING	The passed Mode of the page. Display/New/Review */
$ThisMode = '<null>';

/** OBJECT	The page object that will be Loaded, Processed, and Displayed. */
$ThisPageObject = '<null>';

/** OBJECT The Viewer's access Level */			
$ThisViewerAccessLevel = '<null>';
