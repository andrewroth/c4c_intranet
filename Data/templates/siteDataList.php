...
<?
	if ( !isset($linkValues['add'] ) )
	{
		if ( isset($addFormAction) && isset($addFormLabel) && isset($addFormField) && isset($addButtonText))
		{
			echo '<table width="100%" border="0">';
?>
			<form name="Form" id="Form" method="post" action="<?=$addFormAction;?>">
