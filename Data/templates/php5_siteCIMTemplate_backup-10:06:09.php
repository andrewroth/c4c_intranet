				...
				<td width="100%" height="118" colspan="5" valign="bottom">
					<div align="left">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="223450" > 
							<tr>
								<td width="1" >
									<img src="<?=$pathToRoot;?>Images/space.gif" width="1" height="165">
								</td>
								<td>
								    <table width="100%" height="118" cellpadding="0" cellspacing="0" border="0" >
								        <tr>
								            <td width="336" background="<?=$pathToRoot;?>Images/header_bg.gif">
								                <table width="336" height="165" border="0">
								                    <tr valign="bottom">
								                        <td>
                                                            <?
            								...
            								<td width="*" background="<?=$pathToRoot;?>Images/header_bg.gif">&nbsp;</td>
                                            <td width="229" background="<?=$pathToRoot;?>Images/header_bg.gif">&nbsp;</td>
                                </tr>
                            </table>
								</td>
								<td width="1" >
