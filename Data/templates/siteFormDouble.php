 ...
 * genFormDouble.php
 *
 * This template displays a Double Entry form.  This type of form displays
...
<?
    ...
    for ($indx=0; $indx<count( $formFieldList ); $indx++) {
        ...
        <td class="text">';
            ...
            if ($itemType != 'label') {			//this->formFieldInvalid[ $this->formFields[$indx] ]			reqFieldList
	            ...
	            {
		            echo '<div class="notice">'.$templateTools->getPageLabel('[formLabel_'.$fieldName.']').'</div>';   
               }
               else
               {
...
<hr>
<div align="middle">
<input name="formSubmit" type="submit" value="<?=$button1Text; ?>" />
<input name="formSubmit" type="submit" value="<?=$button2Text; ?>" />
</div>
</form>
