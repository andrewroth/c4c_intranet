 ...
 */ 
/**
 * class FormProcessor_PrcMethod 
 * <pre> 
 * Page for managing PRC methods
 * </pre>
 * @author Russ Martin
 * Date:   22 Jun 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_PrcMethod extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'prcMethod_desc|T|';
    ...
    const DISPLAY_FIELDS = 'prcMethod_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_PrcMethod';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $prcMethod_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $prcMethod_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_PrcMethod::FORM_FIELDS;
        $fieldTypes = FormProcessor_PrcMethod::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_PrcMethod::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_PrcMethodManager( $prcMethod_id );
        ...
        $pageKey = FormProcessor_PrcMethod::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return prcMethod_id to ''
        $this->prcMethod_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->prcMethod_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'prcMethod_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_PrcMethodManager();
        if ( $this->sortBy == '' )
        {
            $this->sortBy = 'prcMethod_desc';
        }
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new PrcMethodList( $this->sortBy );
		...
		//$templateName = 'page_PrcMethod.php';
