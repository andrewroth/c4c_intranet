 ...
 */ 
/**
 * class FormProcessor_PRC 
 * <pre> 
 * Page for seeing and adding info related to PRCs
 * </pre>
 * @author Russ Martin
 * Date:   22 Jun 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_PRC extends PageDisplay_FormProcessor_AdminBox {
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $prc_id [STRING] The init data for the dataManager obj
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $prc_id , $prcMethod_id='', $semester_id='', $campus_id='')
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_PRC::FORM_FIELDS;
        $fieldTypes = FormProcessor_PRC::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_PRC::DISPLAY_FIELDS;
        ...
        $pageKey = FormProcessor_PRC::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // else 
            ...
            // dont' save this one since it comes from the form
        ...
        // on a successful update return prc_id to ''
        $this->prc_id='';
