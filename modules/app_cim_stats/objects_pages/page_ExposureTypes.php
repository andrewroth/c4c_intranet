 ...
 */ 
/**
 * class FormProcessor_ExposureTypes 
 * <pre> 
 * Page for edit/add/delete different EV exposure types.
 * </pre>
 * @author Russ Martin
 * Date:   28 Jun 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_ExposureTypes extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'exposuretype_desc|T|';
    ...
    const DISPLAY_FIELDS = 'exposuretype_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_ExposureTypes';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $exposuretype_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $exposuretype_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_ExposureTypes::FORM_FIELDS;
        $fieldTypes = FormProcessor_ExposureTypes::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_ExposureTypes::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_ExposureTypeManager( $exposuretype_id );
        ...
        $pageKey = FormProcessor_ExposureTypes::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return exposuretype_id to ''
        $this->exposuretype_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->exposuretype_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'exposuretype_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_ExposureTypeManager();
        if ( $this->sortBy == '' )
        {
            $this->sortBy = 'exposuretype_desc';
        }
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new ExposureTypeList( $this->sortBy );
		...
		//$templateName = 'page_ExposureTypes.php';
