 ...
 */ 
/**
 * class FormProcessor_StaffAdditionalWeeklyStats 
 * <pre> 
 * Where staff can enter additional stats for the week.
 * </pre>
 * @author Russ Martin
 * Date:   15 Jul 2006
 */
 // RAD Tools: FormSingleEntry Page
class  FormProcessor_StaffAdditionalWeeklyStats extends PageDisplay_FormProcessor {
    ...
    //                             '<skip>' for this value. 
    const FORM_FIELDS = 'staff_id|N|<skip>,week_id|N|<skip>,campus_id|N|<skip>,weeklyReport_cjVideo|N|,weeklyReport_mda|N|,weeklyReport_otherEVMats|N|,weeklyReport_rlk|N|,weeklyReport_siq|N|,weeklyReport_notes|T|<skip>';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = '-,jumplist,jumplist,textbox,textbox,textbox,textbox,textbox,textarea';
    
    /** The Multilingual Page Key for this page */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_StaffAdditionalWeeklyStats';
