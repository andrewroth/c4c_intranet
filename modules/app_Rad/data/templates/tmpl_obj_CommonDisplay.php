<table width="530" border="0" cellpadding="10" cellspacing="0">
        <tr>
            <td colspan="2"><p class="bold">Common Display Template</p><p class="text">You will probably want to change this ...</p> <p class="smalltext"> (you can do this in the file: [RAD_PATH_TEMPLATES]obj_CommonDisplay.php)</p></td>
        </tr>
        <tr> 
