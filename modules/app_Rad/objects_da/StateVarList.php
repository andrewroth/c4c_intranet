 ...
 * class StateVarList
 * <pre> 
 * This object manages the listing of the statevar table elements.
 * </pre>
...
class  StateVarList {
    ...
    const XML_NODE_NAME = 'StateVarList';
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_StateVarManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=StateVarList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_StateVarManager() ) ) {
