 ...
 * <pre> 
 * This object manages the listing of the transitions table elements.
 * </pre>
...
class  TransitionsList {
    ...
    const XML_NODE_NAME = 'TransitionsList';
	 ...
	 * @param $page_id [INTEGER] optional page_id used to initialize the list.
     * @return [void]
	 */
    function __construct( $module_id=-1,  $sortBy='', $page_id='' ) 
    {
        $searchManager = new RowManager_TransitionsManager();
        ...
        $searchManager->setValueByFieldName("transition_fromObjID", $page_id );
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_TransitionsManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=TransitionsList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_TransitionsManager() ) ) {
