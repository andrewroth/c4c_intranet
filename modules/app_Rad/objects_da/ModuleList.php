 ...
 * class ModuleList
 * <pre> 
 * This object manages the listing of the module table elements.
 * </pre>
...
class  ModuleList {
    ...
    const XML_NODE_NAME = 'ModuleList';
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_ModuleManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=ModuleList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_ModuleManager() ) ) {
