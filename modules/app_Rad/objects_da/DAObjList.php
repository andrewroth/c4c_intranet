 ...
 * class DAObjList
 * <pre> 
 * This object manages the listing of the daobj table elements.
 * </pre>
...
class  DAObjList {
    ...
    {
        $searchManager = new RowManager_DAObjManager();
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_DAObjManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=DAObjList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_DAObjManager() ) ) {
