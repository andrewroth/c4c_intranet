 ...
 */ 
/**
 * class PageLabelsList
 * <pre> 
 * This object manages the listing of the pagelabels table elements.
 * </pre>
...
class  PageLabelsList {
    ...
    const XML_NODE_NAME = 'PageLabelsList';
     ...
     * @return [void]
	 */
    function __construct( $page_id=-1,  $sortBy='' ) 
    {
        $searchManager = new RowManager_PageLabelsManager();
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_PageLabelsManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=PageLabelsList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_PageLabelsManager() ) ) {
