 ...
 * class DAFieldList
 * <pre> 
 * This object manages the listing of the dafield table elements.
 * </pre>
...
class  DAFieldList {
    ...
    const XML_NODE_NAME = 'DAFieldList';
     ...
     * @return [void]
	 */
    function __construct( $daobj_id=-1,  $sortBy='' ) 
    {
        $searchManager = new RowManager_DAFieldManager();
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_DAFieldManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=DAFieldList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_DAFieldManager() ) ) {
