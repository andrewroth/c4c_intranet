 ...
 */ 
/**
 * class FormProcessor_AddPage 
 * <pre> 
 * Add a new page description to this module
 * </pre>
 * @author Johnny Hausman
 * Date:   23 Mar 2005
 */
class  FormProcessor_AddPage extends PageDisplay_FormProcessor {
    ...
    //                             '<skip>' for this value. 
    const FORM_FIELDS = 'page_name|T|,page_desc|T|,page_type|T|-,page_isAdd|B|,page_rowMgrID|T|<skip>,page_listMgrID|T|<skip>,page_isDefault|B|,module_id|T|<skip>';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'textbox,textarea,droplist,checkbox,droplist,droplist,checkbox,-';
    
    /** The Multilingual Page Key for this page */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AddPage';
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $page_id , $module_id='') 
    {
        ...
        parent::__construct( $formAction, FormProcessor_AddPage::FORM_FIELDS, FormProcessor_AddPage::FORM_FIELD_TYPES );
        ...
        $pageKey = FormProcessor_AddPage::MULTILINGUAL_PAGE_KEY;
    ...
    function getHTML() 
    {
        ...
        $fieldTypes = explode(',', FormProcessor_AddPage::FORM_FIELD_TYPES);
