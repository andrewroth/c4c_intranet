 ...
 */ 
/**
 * class FormProcessor_AddModule 
 * <pre> 
 * Adds a new module to the RAD tool
 * </pre>
 * @author Johnny Hausman
 * Date:   23 Mar 2005
 */
class  FormProcessor_AddModule extends PageDisplay_FormProcessor {
    ...
    //                             '<skip>' for this value. 
    const FORM_FIELDS = 'module_name|T|,module_desc|T|,module_creatorName|T|,module_isCommonLook|B|,module_isCore|B|';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'textbox,textarea,textbox,checkbox,checkbox';
    
    /** The Multilingual Page Key for this page */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AddModule';
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $module_id ) 
    {
        ...
        parent::__construct( $formAction, FormProcessor_AddModule::FORM_FIELDS, FormProcessor_AddModule::FORM_FIELD_TYPES );
        ...
        $pageKey = FormProcessor_AddModule::MULTILINGUAL_PAGE_KEY;
    ...
    function isDataValid() 
    {
        ...
        if ($isValid) {
            ...
            $currentName = $this->formValues['module_name'];
            $isValid = $this->dataManager->isUniqueModuleName( $currentName );
    ...
    function getHTML() 
    {
        ...
        $fieldTypes = explode(',', FormProcessor_AddModule::FORM_FIELD_TYPES);
		...
		//$templateName = 'page_AddModule.php';
	 ...
	 * <pre>
	 * This method returns the module id created by the dataManager.
	 * </pre>
	 * @return [INTEGER] 
	 */
    function getModuleID() 
    {
        return $this->dataManager->getModuleID();
    }
