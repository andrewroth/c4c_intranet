...
class  FormProcessor_AddStateVar extends PageDisplay_FormProcessor {
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $statevar_id, $module_id="" )
    {
        ...
        parent::__construct( $formAction, FormProcessor_AddStateVar::FORM_FIELDS, FormProcessor_AddStateVar::FORM_FIELD_TYPES );
    ...
    function getHTML() 
    {
        ...
        // add list values for the type drop list 
