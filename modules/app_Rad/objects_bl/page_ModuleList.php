 ...
 */ 
/**
 * class page_ModuleList 
 * <pre> 
 * Displays the list of modules currently in the system.
 * </pre>
...
class  page_ModuleList {
    ...
    const MULTILINGUAL_PAGE_KEY = 'page_ModuleList';
...
//        $this->managerInit = $managerInit;
        ...
        $this->listManager = new ModuleList( $sortBy );
         ...
         $pageKey = page_ModuleList::MULTILINGUAL_PAGE_KEY;
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'rowManagerXMLNodeName', RowManager_ModuleManager::XML_NODE_NAME );
        
        // store the field names being displayed
        $fieldNames = explode(',', page_ModuleList::DISPLAY_FIELDS);
        $this->template->set( 'dataFieldList', $fieldNames);
        
        // store the primary key field name for the data being displayed
        $this->template->set( 'primaryKeyFieldName', 'module_id');
        ...
        // example:
        $title = $this->labels->getLabel( '[title_View]');
		...
		//$templateName = 'page_ModuleList.php';
