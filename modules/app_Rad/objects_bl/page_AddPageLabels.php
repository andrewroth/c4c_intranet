 ...
 */ 
/**
 * class FormProcessor_AddPageLabels 
 * <pre> 
 * Tracks multilingual labels for use on a page.
 * </pre>
 * @author Johnny Hausman
 * Date:   23 Mar 2005
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_AddPageLabels extends PageDisplay_FormProcessor {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'pagelabel_key|T|,pagelabel_label|T|,language_id|T|-,page_id|T|<skip>';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'textbox,textarea,droplist,-';
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'pagelabel_key,pagelabel_label,language_id';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AddPageLabels';
	 ...
	 * @param $pagelabel_id [STRING] The init data for the dataManager obj
	 * @param $page_id [STRING] The init data for the dataList obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $pagelabel_id, $page_id="" )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        parent::__construct( $formAction, FormProcessor_AddPageLabels::FORM_FIELDS, FormProcessor_AddPageLabels::FORM_FIELD_TYPES );
        ...
        $this->pagelabel_id = $pagelabel_id;
        ...
        $this->dataManager = new RowManager_PageLabelsManager( $pagelabel_id );
        ...
        $pageKey = FormProcessor_AddPageLabels::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // else 
            ...
            $this->formValues[ 'page_id' ] = $this->page_id;
        ...
        // on a successful update return pagelabel_id to ''
        $this->pagelabel_id='';
