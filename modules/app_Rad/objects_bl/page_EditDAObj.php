 ...
 */ 
/**
 * class FormProcessor_EditDAObj 
 * <pre> 
 * Edits a given Data Access Object definition
 * </pre>
 * @author Johnny Hausman
 * Date:   23 Mar 2005
 */
class  FormProcessor_EditDAObj extends PageDisplay_FormProcessor {
    ...
    //                             '<skip>' for this value. 
    const FORM_FIELDS = 'daobj_name|T|,daobj_desc|T|,daobj_managerInitVarID|T|,daobj_listInitVarID|T|,daobj_isCreated|B|,module_id|T|<skip>,daobj_dbTableName|T|<skip>';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'textbox,textarea,droplist,droplist,checkbox,-,-';
    
    /** The Multilingual Page Key for this page */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditDAObj';
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $daobj_id , $module_id='') 
    {
        ...
        parent::__construct( $formAction, FormProcessor_EditDAObj::FORM_FIELDS, FormProcessor_EditDAObj::FORM_FIELD_TYPES );
        ...
        $pageKey = FormProcessor_EditDAObj::MULTILINGUAL_PAGE_KEY;
...
//        $dbTableName = $moduleName.'_'.$tableName.'manager_'.$tableName;
    ...
    function getHTML() 
    {
        ...
        $fieldTypes = explode(',', FormProcessor_EditDAObj::FORM_FIELD_TYPES);
		...
		//$templateName = 'page_EditDAObj.php';
