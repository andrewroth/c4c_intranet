 ...
 */ 
/**
 * class page_DeletePage 
 * <pre> 
 * Removes a Page from a module.
 * </pre>
...
class  page_DeletePage {
    ...
    const MULTILINGUAL_PAGE_KEY = 'page_DeletePage';
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $managerInit='' ) 
    {
        ...
        $this->itemManager = new RowManager_PageManager( $managerInit );
        ...
        $pageKey = page_DeletePage::MULTILINGUAL_PAGE_KEY;
