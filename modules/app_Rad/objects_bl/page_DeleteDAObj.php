 ...
 */ 
/**
 * class page_DeleteDAObj 
 * <pre> 
 * Removes a Data Access Object from this module
 * </pre>
...
class  page_DeleteDAObj {
    ...
    const MULTILINGUAL_PAGE_KEY = 'page_DeleteDAObj';
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $managerInit='' ) 
    {
        ...
        $this->itemManager = new RowManager_DAObjManager( $managerInit );
        ...
        $pageKey = page_DeleteDAObj::MULTILINGUAL_PAGE_KEY;
