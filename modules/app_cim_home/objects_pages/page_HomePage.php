 ...
 * class page_HomePage 
 * <pre> 
 * The home page of the cim_home module.
 * </pre>
 * @author CIM Team
 * Date:   06 Apr 2006
 */
 // RAD Tools: Custom Page
class  page_HomePage extends PageDisplay {

	//CONSTANTS:
    
    /** The Multilingual Page Key for labels on this page */
    const MULTILINGUAL_PAGE_KEY = 'page_HomePage';
    ...
    function __construct($pathModuleRoot, $viewer ) 
    {
        ...
        $pageKey = page_HomePage::MULTILINGUAL_PAGE_KEY;
    ...
    function getHTML() 
    {
		...
		$templateName = 'page_HomePage.php';
