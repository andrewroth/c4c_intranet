 ...
 */ 
/**
 * class page_SchedulerHome 
 * <pre> 
 * Home page for the Scheduler module.
 * </pre>
 * @author Calvin Jien & Russ Martin
 * Date:   25 Mar 2008
 */
 // RAD Tools: Custom Page
class  page_SchedulerHome extends PageDisplay {

	//CONSTANTS:
    
    /** The Multilingual Page Key for labels on this page */
    const MULTILINGUAL_PAGE_KEY = 'page_SchedulerHome';
    ...
    function __construct($pathModuleRoot, $viewer ) 
    {
        ...
        $pageKey = page_SchedulerHome::MULTILINGUAL_PAGE_KEY;
    ...
    function getHTML() 
    {
		...
		$templateName = 'page_SchedulerHome.php';
