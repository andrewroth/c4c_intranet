 ...
 */ 
/**
 * class FormProcessor_AdminGroupType 
 * <pre> 
 * Interface to manage group types.
 * </pre>
 * @author Calvin Jien & Russ Martin
 * Date:   26 Mar 2008
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_AdminGroupType extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'groupType_desc|T|';
    ...
    const DISPLAY_FIELDS = 'groupType_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AdminGroupType';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $groupType_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $groupType_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_AdminGroupType::FORM_FIELDS;
        $fieldTypes = FormProcessor_AdminGroupType::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_AdminGroupType::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_GroupTypeManager( $groupType_id );
        ...
        $pageKey = FormProcessor_AdminGroupType::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return groupType_id to ''
        $this->groupType_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->groupType_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'groupType_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_GroupTypeManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new GroupTypeList( $this->sortBy );
		...
		//$templateName = 'page_AdminGroupType.php';
