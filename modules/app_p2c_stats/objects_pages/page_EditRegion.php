 ...
 */ 
/**
 * class FormProcessor_EditRegion 
 * <pre> 
 * Allows an admin to manage regions and associate them with particular divisions of particular ministries.
 * </pre>
 * @author Hobbe Smit (on behalf of CIM team)
 * Date:   14 Nov 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditRegion extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'region_name|T|,region_desc|T|,division_id|N|,ministry_id|N|';
    ...
    const DISPLAY_FIELDS = 'region_name,region_desc,division_id,ministry_id';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditRegion';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $region_id [STRING] The init data for the dataManager obj
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $region_id , $division_id='', $ministry_id='')
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditRegion::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditRegion::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditRegion::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_StatsRegionManager( $region_id );
        ...
        $pageKey = FormProcessor_EditRegion::MULTILINGUAL_PAGE_KEY;
...
//             $this->formValues[ 'ministry_id' ] = $this->ministry_id;
        ...
        // on a successful update return region_id to ''
        $this->region_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->region_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'region_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_StatsRegionManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new StatsRegionList( $this->sortBy );
		...
		//$templateName = 'page_EditRegion.php';
