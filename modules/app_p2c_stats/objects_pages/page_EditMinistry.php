 ...
 */ 
/**
 * class FormProcessor_EditMinistry 
 * <pre> 
 * Allows an admin to add/update ministry information for the stats system
 * </pre>
 * @author Hobbe Smit (on behalf of CIM team)
 * Date:   14 Nov 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditMinistry extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'ministry_name|T|,ministry_desc|T|,ministry_website|T|';
    ...
    const FORM_FIELD_TYPES = 'textbox,textarea,textbox';
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'ministry_name,ministry_desc,ministry_website';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditMinistry';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $ministry_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $ministry_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditMinistry::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditMinistry::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditMinistry::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_MinistryManager( $ministry_id );
        ...
        $pageKey = FormProcessor_EditMinistry::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return ministry_id to ''
        $this->ministry_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->ministry_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'ministry_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_MinistryManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new MinistryList( $this->sortBy );
		...
		//$templateName = 'page_EditMinistry.php';
