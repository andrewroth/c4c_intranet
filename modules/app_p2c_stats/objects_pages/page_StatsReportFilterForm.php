 ...
 */ 
/**
 * class FormProcessor_StatsReportFilter 
 * <pre> 
 * Allows a person to generate the statistics list to choose from for reporting
 * (Originally this class was identical to FormProcessor_StatsInputFilter)
 * </pre>
 * @author CIM Team (hsmit)
 * Date:   31 Oct 2007
 */
 // RAD Tools: FormSingleEntry Page
class  FormProcessor_StatsReportFilter extends PageDisplay_FormProcessor {
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_StatsReportFilter';
...
// 					echo "DIVISION";
        ...
        $fieldList = FormProcessor_StatsReportFilter::FORM_FIELDS;
        $fieldDisplayTypes = FormProcessor_StatsReportFilter::FORM_FIELD_TYPES;
...
//echo "form values:<br><pre>".print_r($this->formValues,true)."</pre>";      
        ...
        $pageKey = FormProcessor_StatsReportFilter::MULTILINGUAL_PAGE_KEY;
