 ...
 */ 
/**
 * class FormProcessor_EditLocation 
 * <pre> 
 * Allows admins to manage locations and their associations with a particular region, division, and ministry.
 * </pre>
 * @author Hobbe Smit (on behalf of CIM team)
 * Date:   14 Nov 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditLocation extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'location_name|T|,location_desc|T|,region_id|N|,division_id|N|,ministry_id|N|';
    ...
    const FORM_FIELD_TYPES = 'textbox,textarea,droplist,droplist,droplist';
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'location_name,location_desc,region_id,division_id,ministry_id';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditLocation';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $location_id [STRING] The init data for the dataManager obj
	 * @param $region_id [INTEGER] The foreign key data for the data Manager
	 * @param $division_id [INTEGER] The foreign key data for the data Manager
	 * @param $ministry_id [INTEGER] The foreign key data for the data Manager
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $location_id , $region_id='', $division_id='', $ministry_id='')
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditLocation::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditLocation::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditLocation::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_LocationManager( $location_id );
        ...
        $pageKey = FormProcessor_EditLocation::MULTILINGUAL_PAGE_KEY;
...
//             $this->formValues[ 'region_id' ] = $this->region_id;
//             $this->formValues[ 'division_id' ] = $this->division_id;
//             $this->formValues[ 'ministry_id' ] = $this->ministry_id;
        ...
        // on a successful update return location_id to ''
        $this->location_id='';
