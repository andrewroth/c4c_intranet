...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $downloadType, $eventID = '', $campusID = '' ) 
    {
        parent::__construct( );
        ...
        $this->storeReportData($downloadType, $eventID, $campusID);
...
//        $this->template->set( 'disableHeading', true );
    ...
    protected function storeReportData($reportType, $eventID = '', $campusID = '')
    {
...
//    	echo "FileData = ".$fileData; 
 		...
 		{
	 		case modulecim_reg::DOWNLOAD_EVENT_DATA:
				$fileName =  modulecim_reg::EVENT_DATA_FILE_NAME;
    			$fileData = $dataGetter->getCSVByCampus( $eventID, $campusID );  				
	 			break;
	 		case modulecim_reg::DOWNLOAD_SCHOLARSHIP_DATA:
				$fileName =  modulecim_reg::EVENT_SCHOLARSHIP_FILE_NAME;
