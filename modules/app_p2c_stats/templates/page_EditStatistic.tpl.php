...
if ($editEntryID == '' ) {
    ...
    echo '<input name="submit" type="submit" value="'.$templateTools->getPageLabel('[Add]').'" />';
    echo '</td>';
...
//                         
//                         echo 'the data list array = <pre>'.print_r(${$listName},true)."</pre>";
//                         
//                          echo "The data for ".$keys[0]." is: ".$data.'<br>';
...
// 	                        $temp_array = explode('=', $keys[0]);	// i.e. split 'https://127.0.0.1/campusforchrist.org/php5/index.php?p_Mod=p2c_stats&P=P86&SV54=1'
//  	                        $key_index = $temp_array[count($temp_array) - 1];	// get last bit of data; this is the index we want from jumplink
