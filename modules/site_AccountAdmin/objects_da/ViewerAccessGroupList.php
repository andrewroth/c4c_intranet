 ...
 */ 
/**
 * class ViewerAccessGroupList
 * <pre> 
 * This object manages the listing of the vieweraccessgroup table elements.
 * </pre>
...
class  ViewerAccessGroupList {
    ...
    const XML_NODE_NAME = 'ViewerAccessGroupList';
    ...
    //************************************************************************
	/**
	 * function getAccessGroupArray
	 * <pre>
	 * Returns a list of Access Groups in this list.
	 * </pre>
	 ...
	 */
    function getAccessGroupArray( $labels=null ) 
    {
        ...
        while( $item = $this->getNext() ) {
            ...
            $accessGroup = $item->getAccessGroupManager();
        
            $id = $accessGroup->getID();
            $label = $accessGroup->getLabel( $labels );
			$accessCategory = $accessGroup->getAccessCategoryID();
            if ($accessCategory != RowManager_AccessGroupManager::UNDEFINED_ACCESS_CATEGORY)
				$resultArray[ $id ] = $label;
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_ViewerAccessGroupManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=ViewerAccessGroupList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_ViewerAccessGroupManager() ) ) {
