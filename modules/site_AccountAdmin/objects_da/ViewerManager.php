 ...
 */
class  RowManager_ViewerManager extends RowManager {
  ...
  PRIMARY KEY (viewer_id)
    ...
    /** @var [OBJECT] This viewer's access priviledge object for the Account Admin module. */
    protected $accountAdminAccessPriv;
    ...
    function __construct( $viewerID=-1 ) 
    {
        ...
        $this->accountAdminAccessPriv = null;
	 ...
	 * function getGUID
	 * <pre>
	 * Returns the value of the current object's GUID.
	 * </pre>
	 * @return [STRING]
	 */
    function getGUID() 
	 ...
	 * </pre>
	 * @param $userID [STRING] the user id of the account to load
	 * @return [BOOL]
	 */
	 ...
	 * function loadByGUID
	 * <pre>
	 * Attempts to load this Viewer Account given a GUID.
	 * </pre>
	 * @param $ [STRING] the user id of the account to load
	 * @return [BOOL]
	 */
	 ...
	 * </pre>
	 * @param $ [STRING] The new value of GUID.
	 * @return [void]
	 */
    function setGUID( $GUID ) 
    {
	//	echo "the guid to set is [".$GUID."]<br/>";
