 ...
 * <pre> 
 * This object manages the listing of the accessgroup table elements.
 * </pre>
...
class  AccessGroupList {
    ...
    const XML_NODE_NAME = 'AccessGroupList';
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_AccessGroupManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=AccessGroupList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_AccessGroupManager() ) ) {
