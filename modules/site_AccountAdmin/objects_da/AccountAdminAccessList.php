 ...
 */ 
/**
 * class AccountAdminAccessList
 * <pre> 
 * This object manages the listing of the accountadminaccess table elements.
 * </pre>
...
class  AccountAdminAccessList {
    ...
    const XML_NODE_NAME = 'AccountAdminAccessList';
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_AccountAdminAccessManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=AccountAdminAccessList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_AccountAdminAccessManager() ) ) {
