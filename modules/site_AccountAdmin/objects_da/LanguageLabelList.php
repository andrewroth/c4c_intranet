...
class  LanguageLabelList {
    ...
    const XML_NODE_NAME = 'LanguageLabelList';
     ...
     * @return [void]
	 */
    function __construct(  $languageID, $sortBy='' ) 
    {
        ...
        $searchManager = new RowLabelBridge_LanguageLabelManager(-1, $this->languageID, $this->multiLingualManager);
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowLabelBridge_LanguageLabelManager(-1, $this->languageID, $this->multiLingualManager) );
    }  // end classMethod()
