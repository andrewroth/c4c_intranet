 ...
 */ 
/**
 * class AccessCategoryList
 * <pre> 
 * This object manages the listing of the accesscategory table elements.
 * </pre>
...
class  AccessCategoryList {
    ...
    const XML_NODE_NAME = 'AccessCategoryList';
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_AccessCategoryManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=AccessCategoryList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_AccessCategoryManager() ) ) {
