 ...
 * <pre> 
 * This object manages the listing of the accountgroup table elements.
 * </pre>
...
class  AccountGroupList {
    ...
    const XML_NODE_NAME = 'AccountGroupList';
    ...
    {
        $searchManager = new RowManager_AccountGroupManager();
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_AccountGroupManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=AccountGroupList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_AccountGroupManager() ) ) {
