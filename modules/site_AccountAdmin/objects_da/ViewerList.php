 ...
 * class ViewerList
 * <pre> 
 * This object manages the listing of the viewer table elements.
 * </pre>
...
class  ViewerList {
    ...
    const XML_NODE_NAME = 'ViewerList';
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_ViewerManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=ViewerList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_ViewerManager() ) ) {
