 ...
 */ 
/**
 * class FormProcessor_AccessGroup 
 * <pre> 
 * Enters the access groups for the site.
 * </pre>
 * @author Johnny Hausman
 * Date:   21 Mar 2005
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_AccessGroup extends PageDisplay_FormProcessor {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'accessgroup_id|T|<skip>,label_label|T|,accesscategory_id|T|<skip>';
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AccessGroup';
	 ...
	 * @param $accessgroup_id [STRING] The init data for the dataManager obj
	 * @param $accesscategory_id [STRING] The init data for the dataList obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $accessgroup_id, $accesscategory_id="" )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        parent::__construct( $formAction, FormProcessor_AccessGroup::FORM_FIELDS , FormProcessor_AccessGroup::FORM_FIELD_TYPES);
        ...
        $accessGroupManager = new RowManager_AccessGroupManager( $accessgroup_id );
//        $accessGroupManager->setAccessCategoryID( $accesscategory_id );
        ...
        $this->dataManager = new RowLabelBridge($accessGroupManager, $this->bridgeMultiLingualManager );
        ...
        $pageKey = FormProcessor_AccessGroup::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // else 
            ...
            $this->formValues[ 'accesscategory_id' ] = $this->accesscategory_id;
        ...
        // on a successful update return accessgroup_id to ''
        $this->accessgroup_id='';
