 ...
 */ 
/**
 * class form_AccountGroup 
 * <pre> 
 * This object manages the operation of the Account Group Admin Box.
 * </pre>
 * @author Johnny Hausman
 * Date:   19 Apr 2005
 */
 // RAD Tools: AdminBox Page
class  form_AccountGroup extends PageDisplay_FormProcessor {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'accountgroup_id|N|<skip>,label_label|T|';
    ...
    const MULTILINGUAL_PAGE_KEY = 'form_AccountGroup';
...
/*[RAD_FOREIGN_KEY_VAR]*/
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $accountgroup_id )//[RAD_FOREIGN_KEY_PARAM]
    {
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return accountgroup_id to ''
        $this->accountgroup_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->accountgroup_id );
        ...
        $fieldTypes = explode(',', form_AccountGroup::FORM_FIELD_TYPES);
...
/*[RAD_DAOBJ_FIELD_DATE_PARAM]*/
        ...
        $this->template->set( 'primaryKeyFieldName', 'accountgroup_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
//        $this->dataList = new AccountGroupList( $this->sortBy );
        ...
        $fieldNames = explode(',', form_AccountGroup::DISPLAY_FIELDS);
		...
		//$templateName = 'form_AccountGroup.php';
