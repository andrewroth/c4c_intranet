 ...
 */ 
/**
 * class FormProcessor_AccountAccess 
 * <pre> 
...
class  FormProcessor_AccountAccess extends FormProcessor {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'viewer_id|T|<skip>,accessgroup_id|T|-';
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AccountAccess';
	 ...
	 * @param $vieweraccessgroup_id [STRING] The init data for the dataManager obj
	 * @param $viewer_id [STRING] The init data for the dataList obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $vieweraccessgroup_id, $viewer_id="" )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        parent::__construct( FormProcessor_AccountAccess::FORM_FIELDS );
        ...
        $this->dataManager = new RowManager_ViewerAccessGroupManager( $vieweraccessgroup_id );
        ...
        $pageKey = FormProcessor_AccountAccess::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return vieweraccessgroup_id to ''
        $this->vieweraccessgroup_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->vieweraccessgroup_id );
        ...
        $fieldTypes = explode(',', FormProcessor_AccountAccess::FORM_FIELD_TYPES);
        ...
        $this->template->set( 'primaryKeyFieldName', 'vieweraccessgroup_id');

        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $this->dataList = new ViewerAccessGroupList( $this->viewer_id, $this->sortBy );
        $this->template->setXML( 'dataList', $this->dataList->getXML() );
        
        // store the field names being displayed
        $fieldNames = explode(',', FormProcessor_AccountAccess::DISPLAY_FIELDS);
         ...
         */
        // get dropdown list values of 
        $accessGroupManager = new AccessGroupList('');
        $completeList = $accessGroupManager->getDropListArray();
        $currentList = $this->dataList->getAccessGroupArray();
        $finalList = array_diff( $completeList, $currentList);
        $this->template->set( 'list_accessgroup_id', $completeList );
