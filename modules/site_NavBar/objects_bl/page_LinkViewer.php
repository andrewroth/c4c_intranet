 ...
 */ 
/**
 * class FormProcessor_LinkViewer 
 * <pre> 
 * Associates this link with a registered user id on the site.
 * </pre>
 * @author Johnny Hausman
 * Date:   23 Aug 2005
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_LinkViewer extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'viewer_id|N|,navbarlink_id|T|<skip>';
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_LinkViewer';
	 ...
	 * @param $navlinkviewer_id [STRING] The init data for the dataManager obj
	 * @param $navbarlink_id [STRING] The init data for the dataList obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $navlinkviewer_id, $navbarlink_id="" )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_LinkViewer::FORM_FIELDS;
        $fieldTypes = FormProcessor_LinkViewer::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_LinkViewer::DISPLAY_FIELDS;
        parent::__construct($viewer, $formAction, $sortBy, $fieldList, $fieldTypes, $displayFields );


        $this->pathModuleRoot = $pathModuleRoot;
        
        $this->navlinkviewer_id = $navlinkviewer_id;
        ...
        $this->dataManager = new RowManager_NavLinkViewerManager( $navlinkviewer_id );
        ...
        $pageKey = FormProcessor_LinkViewer::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return navlinkviewer_id to ''
        $this->navlinkviewer_id='';
