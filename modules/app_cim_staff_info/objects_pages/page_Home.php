 ...
 * class page_Home 
 * <pre> 
 * The home page for the staff info module.
 * </pre>
 * @author CIM Team
 * Date:   11 Dec 2006
 */
 // RAD Tools: Custom Page
class  page_Home extends PageDisplay {

	//CONSTANTS:
    
    /** The Multilingual Page Key for labels on this page */
    const MULTILINGUAL_PAGE_KEY = 'page_Home';
    ...
    function __construct($pathModuleRoot, $viewer ) 
    {
        ...
        $seriesKey = modulecim_staff_info::MULTILINGUAL_SERIES_KEY;
        $pageKey = page_Home::MULTILINGUAL_PAGE_KEY;
