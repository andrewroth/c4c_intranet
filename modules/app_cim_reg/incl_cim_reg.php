...
require_once( 'objects_da/RegistrationManager.php' );
...
require_once( 'objects_pages/page_DownloadAIARegReport.php' );
require_once( 'objects_pages/page_PersonRecordCleanUp.php' );
require_once( 'objects_pages/page_PersonRecordCleanUpForm.php' );
require_once( 'objects_pages/page_EmailComposer.php' );
/*[RAD_INCLUDE_PAGES]*/
