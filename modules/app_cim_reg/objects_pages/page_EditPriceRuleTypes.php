 ...
 */ 
/**
 * class FormProcessor_EditPriceRuleTypes 
 * <pre> 
 * Provides an interface for editing global price rule types (i.e. frosh discounts, etc)
 * </pre>
 * @author Russ Martin
 * Date:   28 Jun 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditPriceRuleTypes extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'priceruletypes_desc|T|';
    ...
    const DISPLAY_FIELDS = 'priceruletypes_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditPriceRuleTypes';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $priceruletypes_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $priceruletypes_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditPriceRuleTypes::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditPriceRuleTypes::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditPriceRuleTypes::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_PriceRuleTypeManager( $priceruletypes_id );
        ...
        $pageKey = FormProcessor_EditPriceRuleTypes::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return priceruletypes_id to ''
        $this->priceruletypes_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->priceruletypes_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'priceruletypes_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_PriceRuleTypeManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new PriceRuleTypeList( $this->sortBy );
		...
		//$templateName = 'page_EditPriceRuleTypes.php';
