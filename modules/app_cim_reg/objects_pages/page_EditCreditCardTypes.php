 ...
 */ 
/**
 * class FormProcessor_EditCreditCardTypes 
 * <pre> 
 * This page provides an interface for editing credit card type information.
 * </pre>
 * @author Russ Martin
 * Date:   28 Jun 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditCreditCardTypes extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'cctype_desc|T|';
    ...
    const DISPLAY_FIELDS = 'cctype_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditCreditCardTypes';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $cctype_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $cctype_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditCreditCardTypes::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditCreditCardTypes::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditCreditCardTypes::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_CreditCardTypeManager( $cctype_id );
        ...
        $pageKey = FormProcessor_EditCreditCardTypes::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return cctype_id to ''
        $this->cctype_id='';
