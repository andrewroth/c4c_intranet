 ...
 */ 
/**
 * class FormProcessor_AddSuperAdmin 
 * <pre> 
 * Here you can create new super administrators by selecting their user name.
 * </pre>
 * @author Russ Martin
 * Date:   29 Jun 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_AddSuperAdmin extends PageDisplay_FormProcessor_AdminBox {
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AddSuperAdmin';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $superadmin_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $superadmin_id ) //, $viewer_id='')
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_AddSuperAdmin::FORM_FIELDS;
        $fieldTypes = FormProcessor_AddSuperAdmin::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_AddSuperAdmin::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_SuperAdminAssignmentManager( $superadmin_id );
        ...
        $pageKey = FormProcessor_AddSuperAdmin::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return superadmin_id to ''
        $this->superadmin_id='';
