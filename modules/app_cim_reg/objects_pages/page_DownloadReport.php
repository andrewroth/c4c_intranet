 ...
 * Date:   23 Jul 2007
 */
class  page_DownloadReport extends PageDisplay {
...
//    const DISPLAY_FIELDS = '';
    ...
    const MULTILINGUAL_PAGE_KEY = 'page_DownloadReport';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $downloadType, $eventID = '', $campusID = '', $file_name_list = '' ) 
    {
        parent::__construct( );
        ...
        $this->storeReportData($downloadType, $eventID, $campusID, $file_name_list);
 ...
 */        
         ...
         $pageKey = page_DownloadReport::MULTILINGUAL_PAGE_KEY;
    ...
    function getHTML() 
    {
        ...
        switch ($this->download_type)
        {
	        ...
	        case modulecim_reg::DOWNLOAD_SCHOLARSHIP_DATA:
	        		$downloadLinks[ 'DownloadScholarshipDataDump' ]  = $this->linkValues[ 'DownloadScholarshipDataDump' ];
	         	break;
	        default:
	        		break;
        	}
...
//    	echo "FileData = ".$fileData; 
 		...
 		{
	 		case modulecim_reg::DOWNLOAD_EVENT_DATA:
				$fileName =  $fileNames[0];	//modulecim_reg::EVENT_DATA_FILE_NAME;
...
// 				$filePath = tempnam($fileDir, $filePrefix);
    			$fileData = $dataGetter->getCSVByCampus( $eventID, $campusID );  				
	 			break;
	 		case modulecim_reg::DOWNLOAD_SCHOLARSHIP_DATA:
				$fileName =  $fileNames[1];	//modulecim_reg::EVENT_SCHOLARSHIP_FILE_NAME;
