 ...
 */ 
/**
 * class FormProcessor_EditPriceRules 
 * <pre> 
 * This page is used to edit event-specific pricing rules.
 * </pre>
 * @author Russ Martin
 * Date:   29 Jun 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditPriceRules extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'priceruletypes_id|N|,pricerules_desc|T|,fields_id|N|<skip>,pricerules_value|T|,pricerules_discount|N|,event_id|T|<skip>';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'droplist,textarea,droplist,textbox,textbox,-';
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'priceruletypes_id,pricerules_desc,fields_id,pricerules_value,pricerules_discount';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditPriceRules';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $pricerules_id [STRING] The init data for the dataManager obj
	 * @param $event_id [INTEGER] The foreign key data for the data Manager
	 * @param $priceruletypes_id [INTEGER] The foreign key data for the data Manager
	 * @param $fields_id [INTEGER] The foreign key data for the data Manager
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $pricerules_id , $event_id='') 	//, $priceruletypes_id='', $fields_id='')
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditPriceRules::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditPriceRules::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditPriceRules::DISPLAY_FIELDS;
        parent::__construct($viewer, $formAction, $sortBy, $fieldList, $fieldTypes, $displayFields );


        $this->pathModuleRoot = $pathModuleRoot;
        
        $this->pricerules_id = $pricerules_id;

        $this->event_id = $event_id;

        //$this->priceruletypes_id = $priceruletypes_id;
        ...
        $this->dataManager = new RowManager_PriceRuleManager( $pricerules_id );
        ...
        $pageKey = FormProcessor_EditPriceRules::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // else 
            ...
            //$this->formValues[ 'priceruletypes_id' ] = $this->priceruletypes_id;
