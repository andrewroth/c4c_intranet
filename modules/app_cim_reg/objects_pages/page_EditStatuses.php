 ...
 */ 
/**
 * class FormProcessor_EditStatuses 
 * <pre> 
 * Used to manage the registration statuses available to the entire registration system.
 * </pre>
 * @author Russ Martin
 * Date:   04 Jul 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditStatuses extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'status_desc|T|';
    ...
    const DISPLAY_FIELDS = 'status_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditStatuses';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $status_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $status_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditStatuses::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditStatuses::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditStatuses::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_StatusManager( $status_id );
//         $this->dataManager->setFieldsOfInterest( $fieldsOfInterest );
        ...
        $pageKey = FormProcessor_EditStatuses::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        /*[RAD_ADMINBOX_FOREIGNKEY]*/
            ...
            if (!$this->dataManager->isLoaded()) {
	             $this->formValues['status_id'] = $this->getNextStatusID();             
	             $this->dataManager->loadFromArray( $this->formValues );
        ...
        // on a successful update return status_id to ''
        $this->status_id='';
        
        
    } // end processData()
 
     // retrieve next status ID for insertion
     protected function getNextStatusID()
     {
			...
			$statuses->ignoreFields();	// only leave MAX(status_id) in values to be returned
         ...
         $maxID = -1;
	      reset($statusesArray);
			...
			return $maxID+1;	// NOTE: equals 0 if nothing found
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->status_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'status_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_StatusManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new StatusList( $this->sortBy );
		...
		//$templateName = 'page_EditStatuses.php';
