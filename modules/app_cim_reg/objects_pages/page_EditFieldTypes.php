 ...
 */ 
/**
 * class FormProcessor_EditFieldTypes 
 * <pre> 
 * This page used as interface to creating/editing/deleting field types.
 * </pre>
 * @author Russ Martin
 * Date:   28 Jun 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditFieldTypes extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'fieldtypes_desc|T|';
    ...
    const DISPLAY_FIELDS = 'fieldtypes_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditFieldTypes';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $fieldtypes_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $fieldtypes_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditFieldTypes::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditFieldTypes::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditFieldTypes::DISPLAY_FIELDS;
        parent::__construct($viewer, $formAction, $sortBy, $fieldList, $fieldTypes, $displayFields );


        $this->pathModuleRoot = $pathModuleRoot;
        
        $this->fieldtypes_id = $fieldtypes_id;
        ...
        $this->dataManager = new RowManager_FieldTypeManager( $fieldtypes_id );
        ...
        $pageKey = FormProcessor_EditFieldTypes::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return fieldtypes_id to ''
        $this->fieldtypes_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->fieldtypes_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'fieldtypes_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_FieldTypeManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new FieldTypeList( $this->sortBy );
		...
		//$templateName = 'page_EditFieldTypes.php';
