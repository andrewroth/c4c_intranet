 ...
 */ 
/**
 * class FormProcessor_EditPrivilegeTypes 
 * <pre> 
 * This is an interface allowing administrators to create new privilege types.
 * </pre>
 * @author Russ Martin
 * Date:   28 Jun 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditPrivilegeTypes extends PageDisplay_FormProcessor_AdminBox {
    ...
    const DISPLAY_FIELDS = 'priv_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditPrivilegeTypes';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $priv_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $priv_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditPrivilegeTypes::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditPrivilegeTypes::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditPrivilegeTypes::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_PrivilegeTypeManager( $priv_id );
        ...
        $pageKey = FormProcessor_EditPrivilegeTypes::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return priv_id to ''
        $this->priv_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->priv_id );
        ...
        $dataAccessManager = new RowManager_PrivilegeTypeManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new PrivilegeTypeList( $this->sortBy );
		...
		//$templateName = 'page_EditPrivilegeTypes.php';
