 ...
 */ 
/**
 * class FormProcessor_EditRegistrationFieldValuesForm 
 * <pre> 
 * (Sub-)page used to edit the event-specific form field values for a particular registrant.
 * </pre>
 * @author Russ Martin
 * Date:   12 Jul 2007
 */
 // RAD Tools: FormSingleEntry Page
class  FormProcessor_EditRegistrationFieldValuesForm extends PageDisplay_FormProcessor {
    ...
    const FORM_FIELD_TYPES = '-,textarea,-';
    
    /** The Multilingual Page Key for this page */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditRegistrationFieldValuesForm';
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $fieldvalues_id ,  $registration_id) 
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditRegistrationFieldValuesForm::FORM_FIELDS;
        $fieldDisplayTypes = FormProcessor_EditRegistrationFieldValuesForm::FORM_FIELD_TYPES;
...
//        $this->fields_id = $fields_id;
        ...
        $this->dataManager->setRegID($this->registration_id);
        ...
        $pageKey = FormProcessor_EditRegistrationFieldValuesForm::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function getHTML() 
    {
      ...
      $this->template->set( 'disableHeading', true );   
		...
		//$templateName = 'page_EditRegistrationFieldValuesForm.php';
