<?
/*
 * DisplayCCtransactionReceipt.tpl.php
 *
 ...
 else		// display receipt data
 {
	...
	?>
	 ...
	 <tr valign="top" <?= $rowColor;?> >
	 	...
	 	<td colspan="1" class="<? echo $boldStyle?>" ><? echo $templateTools->getPageLabel('[StatusInfo]'); ?></td>
	 </tr>
	 <tr>
		...
		<td colspan="1" width="25%" valign="top">	
	        <span class="<? echo $textStyle?>" >
	              <table width = "100%" border="0">
	                  ...
	                  <tr>
	                      <td colspan="1" class="<? echo $textStyle?>" >
	                      <? echo $campusStatus.', <br>'.$campusName;
	                      ?></td>
	                  </tr>
	                  <!-- spacer -->
	                  ...
	                  <tr>
	                      <td colspan="1" class="<? echo $textStyle?>" >
	                      <? echo 'Registration Status:  <br>'.$regStatus;
	                      ?></td>
	                  </tr>
	                  <!-- spacer -->
	                  <tr><td colspan="1">&nbsp;</td></tr>
