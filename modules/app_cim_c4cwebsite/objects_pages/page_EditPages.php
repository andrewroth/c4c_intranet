 ...
 */ 
/**
 * class FormProcessor_EditPages 
 * <pre> 
 * Allows for addition and editing of page objects
 * </pre>
 * @author Russ Martin, Jon Baelde, Valera Strugov
 * Date:   10 Jul 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditPages extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'page_parentID|N|,page_breadcrumbTitle|T|,page_templateName|T|,page_link|T|,page_order|N|,page_keywords|T|';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'droplist,textbox|30,textbox|100,textbox|100,textbox,textarea';
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'page_parentID,page_breadcrumbTitle,page_link';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditPages';
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return page_id to ''
        $this->page_id='';
