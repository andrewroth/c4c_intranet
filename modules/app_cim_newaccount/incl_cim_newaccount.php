...
//		
// cim_newaccount Includes
//
//	This file includes the required classes used by the cim_newaccount Module.
//
...
require_once( 'objects_pages/page_CreatedSuccessfully.php' );
require_once( 'objects_pages/page_RecoverLoginDetails.php' );
require_once( 'objects_pages/page_EmailSentSuccessfully.php' );
require_once( 'objects_pages/page_GCXFirstLogin.php' );
