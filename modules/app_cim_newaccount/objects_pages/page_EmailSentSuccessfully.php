 ...
 */ 
/**
 * class page_EmailSentSuccessfully 
 * <pre> 
...
class  page_EmailSentSuccessfully extends PageDisplay {

	//CONSTANTS:
    
    /** The Multilingual Page Key for labels on this page */
    const MULTILINGUAL_PAGE_KEY = 'page_EmailSentSuccessfully';
    ...
    function __construct($pathModuleRoot, $viewer ) 
    {
        ...
        $pageKey = page_EmailSentSuccessfully::MULTILINGUAL_PAGE_KEY;
