...
if ($showjumpList){
   $templateTools->showJumpListByArray( 'campus', $defaultCampus, $jumpList, false);
    ...
    if ( isset($downloadLink[ 'DownloadSeniorityCSV' ]) ) {
        echo '<div align="right" class="text" ><a href="'.$downloadLink[ 'DownloadSeniorityCSV' ].'">'.$linkLabels['DownloadSeniorityCSV'].'</a></div>';
    }    
