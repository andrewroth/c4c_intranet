 ...
 */ 
/**
 * class FormProcessor_EditAccessAssignment 
 * <pre> 
 * Allows a person record to be associated with some viewer/user record. Mostly intended for display purposes.
 * </pre>
 * @author CIM Team
 * Date:   24 Nov 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditAccessAssignment extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'viewer_id|N|,person_id|N|';
    ...
    const DISPLAY_FIELDS = 'viewer_id,person_id';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditAccessAssignment';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $access_id [STRING] The init data for the dataManager obj
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $access_id , $viewer_id='', $person_id='')
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditAccessAssignment::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditAccessAssignment::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditAccessAssignment::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_ViewerToPersonAssignmentManager( $access_id );
        ...
        $pageKey = FormProcessor_EditAccessAssignment::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return access_id to ''
        $this->access_id='';
