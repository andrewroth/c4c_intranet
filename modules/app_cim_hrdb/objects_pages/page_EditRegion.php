 ...
 * <pre> 
 * Allows admins to add/remove/update regions used within the intranet.
 * </pre>
 * @author CIM Team
 * Date:   22 Aug 2007
 */
...
class  FormProcessor_EditRegion extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'reg_desc|T|,country_id|N|';
    ...
    const FORM_FIELD_TYPES = 'textbox,droplist';
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'reg_desc,country_id';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $region_id )
    {
        ...
        $this->dataManager = new RowManager_RegionManager( $region_id );
...
///        }
    ...
    function getHTML() 
    {
        ...
        $dataAccessManager = new RowManager_RegionManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new RegionList( $this->sortBy );
