 ...
 */ 
/**
 * class FormProcessor_AdminPrivs 
 * <pre> 
 * A page to display the previliges an admin has.
 * </pre>
 * @author CIM Team
 * Date:   14 Apr 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_AdminPrivs extends PageDisplay_FormProcessor_AdminBox {
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AdminPrivs';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $admin_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $admin_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_AdminPrivs::FORM_FIELDS;
        $fieldTypes = FormProcessor_AdminPrivs::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_AdminPrivs::DISPLAY_FIELDS;
        ...
        $this->dataManager->setAdminID($this->admin_id);
        ...
        $pageKey = FormProcessor_AdminPrivs::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return admin_id to ''
        $this->admin_id='';
