 ...
 */ 
/**
 * class FormProcessor_EditPerson 
 * <pre> 
 * This is the page to edit a person.
 * </pre>
 * @author CIM Team
 * Date:   06 Apr 2006
 */
 // RAD Tools: FormSingleEntry Page
class  FormProcessor_EditPerson extends PageDisplay_FormProcessor {
    ...
    //                             '<skip>' for this value. 
    const FORM_FIELDS = 'person_fname|T|,person_lname|T|,person_legal_fname|T|<skip>,person_legal_lname|T|<skip>,person_email|T|<skip>,gender_id|N|,person_phone|T|<skip>,person_local_phone|T|<skip>,person_addr|T|<skip>,person_city|T|<skip>,person_pc|T|<skip>,province_id|N|<skip>,person_local_addr|T|<skip>,person_local_city|T|<skip>,person_local_pc|T|<skip>,person_local_province_id|N|<skip>';
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditPerson';
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $person_id ) 
    {
        ...
        $fieldList = FormProcessor_EditPerson::FORM_FIELDS;
        $fieldDisplayTypes = FormProcessor_EditPerson::FORM_FIELD_TYPES;
        ...
        $pageKey = FormProcessor_EditPerson::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function getHTML() 
    {
		...
		//$templateName = 'page_EditPerson.php';
