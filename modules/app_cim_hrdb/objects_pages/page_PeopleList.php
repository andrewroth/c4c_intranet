 ...
 */ 
/**
 * class FormProcessor_PeopleList 
 * <pre> 
 * A list to Add/Edit People.
 * </pre>
 * @author CIM Team
 * Date:   03 Apr 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_PeopleList extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'person_fname|T|,person_lname|T|,person_phone|T|,person_email|T|,person_addr|T|,person_city|T|,province_id|N|,person_pc|T|,gender_id|N|';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'textbox,textbox,textbox,textbox,textbox,textbox,droplist,textbox,droplist';
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_PeopleList';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $person_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $person_id )
    {
        ...
        $fieldList = FormProcessor_PeopleList::FORM_FIELDS;
        $fieldTypes = FormProcessor_PeopleList::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_PeopleList::DISPLAY_FIELDS;
        ...
        $pageKey = FormProcessor_PeopleList::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return person_id to ''
        $this->person_id='';
...
//        $this->dataList = new PersonList( $this->sortBy );
		...
		//$templateName = 'page_PeopleList.php';
