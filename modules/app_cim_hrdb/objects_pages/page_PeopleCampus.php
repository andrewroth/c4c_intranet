 ...
 */ 
/**
 * class FormProcessor_PeopleCampus 
 * <pre> 
 * This is the page with the droplist and displays only the people from the selected campus.
 * </pre>
 * @author CIM Team
 * Date:   07 Apr 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_PeopleCampus extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'province_desc|T|';
    ...
    const DISPLAY_FIELDS = 'person_fname,person_lname';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_PeopleCampus';
...
/* no List Init Variable defined for this DAObj */
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $province_id )
    {
        ...
        $fieldList = FormProcessor_PeopleCampus::FORM_FIELDS;
        $fieldTypes = FormProcessor_PeopleCampus::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_PeopleCampus::DISPLAY_FIELDS;
        ...
        $pageKey = FormProcessor_PeopleCampus::MULTILINGUAL_PAGE_KEY;
...
//        $this->dataList = new PersonList( $this->sortBy );
		...
		//$templateName = 'page_PeopleCampus.php';
