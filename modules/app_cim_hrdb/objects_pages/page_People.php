 ...
 * Date:   03 Apr 2006
 */
class  page_People extends PageDisplay_DisplayList {

	//CONSTANTS:

	/** The list of fields to be displayed */
    const DISPLAY_FIELDS = 'person_fname,person_lname,person_email,person_phone';
    
    /** The Multilingual Page Key for labels on this page */
    const MULTILINGUAL_PAGE_KEY = 'page_People';
...
//        $this->listManager = new PersonList( $sortBy );
    ...
    function getHTML() 
    {
        ...
        // $this->template->set( 'rowManagerXMLNodeName', RowManager_PersonManager::XML_NODE_NAME );
