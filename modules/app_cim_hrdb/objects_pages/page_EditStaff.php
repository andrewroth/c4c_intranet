 ...
 */ 
/**
 * class FormProcessor_EditStaff 
 * <pre> 
 * This is a simple page for adding/editing/deleting staff. It was created because of the need to set staff active status.
 * </pre>
 * @author CIM Team
 * Date:   04 Apr 2008
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditStaff extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'person_id|N|,is_active|N|';
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditStaff';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $staff_id [STRING] The init data for the dataManager obj
	 * @param $person_id [INTEGER] The foreign key data for the data Manager
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $staff_id , $person_id='')
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditStaff::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditStaff::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditStaff::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_StaffManager( $staff_id );
        ...
        $pageKey = FormProcessor_EditStaff::MULTILINGUAL_PAGE_KEY;
    ...
    function processData() 
    {
        ...
        if ( $this->opType == 'D' ) {
            ...
            if ( $this->shouldDelete ) {
                ...
                $this->db_error_msg = $this->dataManager->deleteEntry();	
                $this->setErrorMessage($this->db_error_msg);
            }
...
//             $this->formValues[ 'person_id' ] = $this->person_id;
        /*[RAD_ADMINBOX_FOREIGNKEY]*/
        	   ...
        	   if ( $this->opType != 'U' )		// not delete, not update ==> add operation
        	   {
	        	   $this->dataManager = new RowManager_StaffManager();
        	   }
        ...
        // on a successful update return staff_id to ''
        $this->staff_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->staff_id );
        ...
        $dataAccessManager = new RowManager_StaffManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new StaffList( $this->sortBy );
        ...
        $personManager->setLabelTemplateLastNameFirstNameID();
        ...
        $this->template->set( 'tableWidth', '100%' );
        $templateName = 'siteAdminBox.php';
        // if you are creating a custom template for this page then 
		// replace $templateName with the following:
		//$templateName = 'page_EditStaff.php';
		
		return $this->template->fetch( $templateName );
        
    }
    
    // Simple method for initializing the staff_id
    // REQUIRED TO AVOID BUG WHERE FK CONSTRATIN VIOLATION FOLLOWED BY 'ADD' OPERATION 
    // OVERWRITES THE ID THAT TRIGGERED THE CONSTRAINT
//     public function setStaffID($staffID='')
//     {
// 	    $this->staff_id = $staffID;			
// // ACTUALLY THE PROBLEM IS THAT PAGE MUST BE REFRESHED TO DISPLAY ERROR MESSAGE
// // MEANING THAT 'edit_entryID' IS CHANGED AGAIN IN TEMPLATE (i.e. loaded with ID from botched delete op)
//     }
}
