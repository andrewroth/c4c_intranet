 ...
 */ 
/**
 * class FormProcessor_Privileges 
 * <pre> 
 * Add previliges for the hrdb module
 * </pre>
 * @author CIM Team
 * Date:   31 Mar 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_Privileges extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'priv_accesslevel|T|';
    ...
    const DISPLAY_FIELDS = 'priv_accesslevel';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_Privileges';
...
/* no List Init Variable defined for this DAObj */
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $priv_id )
    {
        ...
        $fieldList = FormProcessor_Privileges::FORM_FIELDS;
        $fieldTypes = FormProcessor_Privileges::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_Privileges::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_PrivManager( $priv_id );
        ...
        $pageKey = FormProcessor_Privileges::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function getHTML() 
    {
        ...
        $dataAccessManager = new RowManager_PrivManager();
...
//        $this->dataList = new PrivList( $this->sortBy );
		...
		//$templateName = 'page_Privileges.php';
