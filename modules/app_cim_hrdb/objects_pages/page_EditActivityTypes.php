 ...
 */ 
/**
 * class FormProcessor_EditActivityTypes 
 * <pre> 
 * Allows admins to add/edit/insert staff activity types (i.e. Vacation, IBS, etc).
 * </pre>
 * @author CIM Team
 * Date:   27 Mar 2008
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditActivityTypes extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'activitytype_desc|T|,activitytype_abbr|T|,activitytype_color|T|';
    ...
    const FORM_FIELD_TYPES = 'textarea|15|4,textbox,textbox';
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'activitytype_desc,activitytype_abbr,activitytype_color';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditActivityTypes';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $activitytype_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $activitytype_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditActivityTypes::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditActivityTypes::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditActivityTypes::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_ActivityTypeManager( $activitytype_id );
        ...
        $pageKey = FormProcessor_EditActivityTypes::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return activitytype_id to ''
