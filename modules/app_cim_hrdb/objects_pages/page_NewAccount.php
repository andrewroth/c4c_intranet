 ...
 */ 
/**
 * class FormProcessor_NewAccount
 * <pre> 
 * New Person
 * </pre>
 * @author CIM Team
...
class  FormProcessor_NewAccount extends PageDisplay_FormProcessor {
    ...
    //                             '<skip>' for this value.
    const FORM_FIELDS = 'accountgroup_id|T|<skip>,viewer_userID|T|,viewer_passWord|T|,pword2|T|,viewer_userID,person_fname|T|,person_lname|T|,person_phone|T|,person_email|T|,gender_id|N|,person_addr|T|,person_city|T|,province_id|N|,person_pc|T|';

    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = '-,textbox,password,password,textbox,textbox,textbox,textbox,droplist,textbox,textbox,droplist,textbox';
