 ...
 */ 
/**
 * class FormProcessor_EditPeople 
 * <pre> 
 * An interface into the cim_hrdb_person table that allows admins to view all people in the system along with each of their e-mail addresses. Editing of these fields will also be possible.
 * </pre>
 * @author CIM Team
 * Date:   27 Aug 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditPeople extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'person_fname|T|,person_lname|T|,person_phone|T|,person_email|T|';
    ...
    const DISPLAY_FIELDS = 'person_fname,person_lname,person_phone,person_email';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditPeople';
...
/* no List Init Variable defined for this DAObj */
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $person_id )
    {
        ...
        $fieldList = FormProcessor_EditPeople::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditPeople::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditPeople::DISPLAY_FIELDS;
        ...
        $pageKey = FormProcessor_EditPeople::MULTILINGUAL_PAGE_KEY;
