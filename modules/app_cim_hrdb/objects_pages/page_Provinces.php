...
class  FormProcessor_Provinces extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'province_desc|T|,province_shortDesc|T|';
    ...
    const DISPLAY_FIELDS = 'province_desc,province_shortDesc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_Provinces';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $province_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $province_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_Provinces::FORM_FIELDS;
        $fieldTypes = FormProcessor_Provinces::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_Provinces::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_ProvinceManager( $province_id );
        ...
        $pageKey = FormProcessor_Provinces::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function getHTML() 
    {
        ...
        // echo 'the province_id['.$this->province_id.']<br/>';

        // store the statevar id to edit
        $this->template->set( 'editEntryID', $this->province_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'province_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_ProvinceManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new ProvinceList( $this->sortBy );
