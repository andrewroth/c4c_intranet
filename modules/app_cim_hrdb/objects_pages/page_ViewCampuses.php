 ...
 */ 
/**
 * class FormProcessor_ViewCampuses 
 * <pre> 
 * View the campuses a campus admin is associated with.
 * </pre>
 * @author CIM Team
 * Date:   06 Apr 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_ViewCampuses extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'admin_id|N|<skip>,campus_id|N|';
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_ViewCampuses';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $campusadmin_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $campusadmin_id , $admin_id)
    {
        // NOTE: be sure to call the parent constructor before trying to
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_ViewCampuses::FORM_FIELDS;
        $fieldTypes = FormProcessor_ViewCampuses::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_ViewCampuses::DISPLAY_FIELDS;
        parent::__construct($viewer, $formAction, $sortBy, $fieldList, $fieldTypes, $displayFields );


        $this->pathModuleRoot = $pathModuleRoot;

        $this->campusadmin_id = $campusadmin_id;
        ...
        $this->dataManager = new RowManager_CampusAdminManager( $campusadmin_id );
        ...
        $pageKey = FormProcessor_ViewCampuses::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // else 
            ...
            $this->formValues[ 'admin_id' ] = $this->admin_id;
        ...
        // on a successful update return campusadmin_id to ''
        $this->campusadmin_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->campusadmin_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'campusadmin_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_CampusAdminManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new CampusAdminList( $this->sortBy );
        $dataAccessManager->setAdminID( $this->admin_id );
		...
		//$templateName = 'page_ViewCampuses.php';
