 ...
 */ 
/**
 * class FormProcessor_EditCampusAssignmentStatusTypes 
 * <pre> 
 * Used to add/delete/update campus assignment status types
 * </pre>
 * @author CIM Team
 * Date:   16 Jul 2007
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_EditCampusAssignmentStatusTypes extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'assignmentstatus_desc|T|';
    ...
    const DISPLAY_FIELDS = 'assignmentstatus_desc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditCampusAssignmentStatusTypes';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $assignmentstatus_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $assignmentstatus_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_EditCampusAssignmentStatusTypes::FORM_FIELDS;
        $fieldTypes = FormProcessor_EditCampusAssignmentStatusTypes::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_EditCampusAssignmentStatusTypes::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_CampusAssignmentStatusManager( $assignmentstatus_id );
        ...
        $pageKey = FormProcessor_EditCampusAssignmentStatusTypes::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return assignmentstatus_id to ''
        $this->assignmentstatus_id='';
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'editEntryID', $this->assignmentstatus_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'assignmentstatus_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_CampusAssignmentStatusManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new CampusAssignmentStatusList( $this->sortBy );
		...
		//$templateName = 'page_EditCampusAssignmentStatusTypes.php';
