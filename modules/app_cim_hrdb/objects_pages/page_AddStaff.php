 ...
 */ 
/**
 * class FormProcessor_AddStaff 
 * <pre> 
 * Add a staff member from a drop down list of people.
 * </pre>
 * @author CIM Team
 * Date:   06 Apr 2006
 */
 // RAD Tools: FormSingleEntry Page
class  FormProcessor_AddStaff extends PageDisplay_FormProcessor {
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_AddStaff';
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $staff_id ) 
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_AddStaff::FORM_FIELDS;
        $fieldDisplayTypes = FormProcessor_AddStaff::FORM_FIELD_TYPES;
        ...
        $pageKey = FormProcessor_AddStaff::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function getHTML() 
    {
		...
		//$templateName = 'page_AddStaff.php';
