...
class  FormProcessor_Campuses extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'campus_desc|T|,campus_shortDesc|T|,region_id|N|';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'textbox,textbox,droplist';
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'campus_desc,campus_shortDesc,region_id';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_Campuses';
	...
	/** @var [STRING] The dataManager error message variable. */
// 	protected $db_error_msg;		// MOVED INTO GENERAL PageDisplay CLASS
	 ...
	 * @param $campus_id [STRING] The init data for the dataManager obj
	 * @param $campus_id [STRING] The init data for the dataList obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $campus_id )
    {
        // NOTE: be sure to call the parent constructor before trying to
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_Campuses::FORM_FIELDS;
        $fieldTypes = FormProcessor_Campuses::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_Campuses::DISPLAY_FIELDS;
...
//         $this->db_error_msg = '';
        ...
        $this->dataManager = new RowManager_CampusManager( $campus_id );
        ...
        $pageKey = FormProcessor_Campuses::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {  
       // echo 'inside process data of campuses<br/>';
        ...
        // on a successful update return campus_id to ''
        $this->campus_id='';
