 ...
 */ 
/**
 * class FormProcessor_CampusAssignments 
 * <pre> 
 * This page is to view a person's campus assignments.
 * </pre>
 * @author CIM Team
 * Date:   06 Apr 2006
 */
 // RAD Tools: AdminBox Page
class  FormProcessor_CampusAssignments extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != ''
    const FORM_FIELDS = 'person_id|N|<skip>,campus_id|N|';
    ...
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_CampusAssignments';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $assignment_id , $person_id='', $campus_id='')
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_CampusAssignments::FORM_FIELDS;
        $fieldTypes = FormProcessor_CampusAssignments::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_CampusAssignments::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_AssignmentsManager( $assignment_id );
        ...
        $pageKey = FormProcessor_CampusAssignments::MULTILINGUAL_PAGE_KEY;
