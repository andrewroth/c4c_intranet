 ...
 */ 
/**
 * class page_HrdbActivities 
 * <pre> 
 * A simple page listing all the possible activity types and allowing admin/access to scheduled staff activities filtered by activity type.
 * </pre>
 * @author CIM Team
 * Date:   18 Mar 2008
 */
class  page_HrdbActivities extends PageDisplay_DisplayList {

	//CONSTANTS:
	
	/** The list of fields to be displayed */
    const DISPLAY_FIELDS = 'activitytype_desc';
    
    /** The Multilingual Page Key for labels on this page */
    const MULTILINGUAL_PAGE_KEY = 'page_HrdbActivities';
...
//        $this->listManager = new ActivityTypeList( $sortBy );
    ...
    function getHTML() 
    {
        ...
        $this->template->set( 'rowManagerXMLNodeName', RowManager_ActivityTypeManager::XML_NODE_NAME );
		...
		//$templateName = 'page_HrdbActivities.php';
