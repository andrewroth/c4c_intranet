...
class  FormProcessor_Countries extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'country_desc|T|,country_shortDesc|T|';
    /** SUGGESTED SHORT DESCRIPTION ARE THE ISO 3166-1 alpha-3 codes: http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3  **/
    ...
    const DISPLAY_FIELDS = 'country_desc,country_shortDesc';
    
    /** The Querystring Field for which entry is currently being edited ... */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_Countries';
...
/* no List Init Variable defined for this DAObj */
	 ...
	 * @param $country_id [STRING] The init data for the dataManager obj
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $country_id )
    {
        // NOTE: be sure to call the parent constructor before trying to 
        //       use the ->formXXX arrays...
        $fieldList = FormProcessor_Countries::FORM_FIELDS;
        $fieldTypes = FormProcessor_Countries::FORM_FIELD_TYPES;
        $displayFields = FormProcessor_Countries::DISPLAY_FIELDS;
        ...
        $this->dataManager = new RowManager_CountryManager( $country_id );
...
//         echo '<pre>'.print_r($this->formValues,true).'</pre>';
        ...
        $pageKey = FormProcessor_Countries::MULTILINGUAL_PAGE_KEY;
...
///        }
    ...
    function processData() 
    {
        ...
        // on a successful update return province_id to ''
        $this->country_id='';
    ...
    function getHTML() 
    {
        ...
        // echo 'the country_id['.$this->country_id.']<br/>';

        // store the statevar id to edit
        $this->template->set( 'editEntryID', $this->country_id );
        ...
        $this->template->set( 'primaryKeyFieldName', 'country_id');
        
        // store data list to the template
        // NOTE: we initialize it here to make sure we capture any new data 
        // from a recent processData() call.
        $dataAccessManager = new RowManager_CountryManager();
        $dataAccessManager->setSortOrder( $this->sortBy );
//        $this->dataList = new CountryList( $this->sortBy );
		...
		//$templateName = 'page_Provinces.php';
