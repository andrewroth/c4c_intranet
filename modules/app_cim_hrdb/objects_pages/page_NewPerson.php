...
class  FormProcessor_NewPerson extends PageDisplay_FormProcessor {
    ...
    /** @var [STRING] The initialization data for the associated dataManager. */
	protected $campus_id;
	 ...
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $person_id, $campus_id = '' )
    {
...
///        }
    ...
    function processData() 
    {
        ...
        if (!$this->dataManager->isLoaded()) {
	        ...
	        if ($this->campus_id != '')		// no point in creating a person record with no campus
	        {
...
// 	            $assignManager->setCampusID($this->campus_id);
	            ...
	            {
	            	$assignManager->createNewEntry();	// associate person with the campus the viewer is viewing
            	}
           }
