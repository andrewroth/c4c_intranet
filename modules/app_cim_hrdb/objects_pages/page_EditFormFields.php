...
class  FormProcessor_EditFormFields extends PageDisplay_FormProcessor_AdminBox {
    ...
    //                             to form_value != '' 
    const FORM_FIELDS = 'fieldtype_id|N|,fields_desc|T|,fields_priority|N|,fields_reqd|B|,fields_invalid|T|<skip>,fields_hidden|B|,datatypes_id|N|,fields_note|T|<skip>,form_name|T|<skip>,staffscheduletype_id|T|<skip>';	//fieldgroup_id|N|,
    ...
    const FORM_FIELD_TYPES = 'droplist,textarea|30|2,textbox,checkbox,textbox,checkbox,droplist,textbox|40|40,hidden,-';		//droplist,
    
    /** The list of fields to be displayed in the data list */
    const DISPLAY_FIELDS = 'fieldtype_id,fields_desc,fields_priority,fields_reqd,fields_invalid,fields_hidden,datatypes_id';	//,fieldgroup_id
...
// 	protected $datatypes_id;
	 ...
	 * @param $staffscheduletype_id [INTEGER] The foreign key data for the data Manager
	 * @param $datatypes_id [INTEGER] The foreign key data for the data Manager
	 * @return [void]
	 */
    function __construct($pathModuleRoot, $viewer, $formAction, $sortBy, $fields_id , $staffscheduletype_id='', $disableHeading=false)  //$fieldtype_id='',  $datatypes_id='')
    {
...
//         $this->datatypes_id = $datatypes_id;
...
//         $_REQUEST['form_name'] = 'editFieldsForm';
...
//             $this->formValues[ 'datatypes_id' ] = $this->datatypes_id;
