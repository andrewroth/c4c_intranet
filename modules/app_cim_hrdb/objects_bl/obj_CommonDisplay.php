...
class  CommonDisplay {
    ...
    function __construct( $modulePath, $rootPath, $viewer ) 
    {
        ...
        // $pageKey = CommonDisplay::MULTILINGUAL_PAGE_FIELDS;
	 ...
	 */
    function getHTML( $pageContentHTML, $errorMessage='') 
    {
        ...
        // store any errors passed along
        if ($errorMessage != '')
        {
        		$this->template->set( 'error_msg', $errorMessage );
     	  }
