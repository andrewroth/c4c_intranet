 ...
 */ 
/**
 * class FormProcessor_EditTemplate 
 * <pre> 
 * edit a template
 * </pre>
 * @author Reuben Uy
...
class  FormProcessor_EditTemplate extends PageDisplay_FormProcessor {
    ...
    //                             '<skip>' for this value. 
    const FORM_FIELDS = 'label_label|T|,template_isactive|B|';
    
    /** The list of field types to be displayed in the form */
    // NOTE: if a field isn't displayed, put a '-' for it's entry.
    const FORM_FIELD_TYPES = 'textarea,checkbox';
    
    /** The Multilingual Page Key for this page */
    const MULTILINGUAL_PAGE_KEY = 'FormProcessor_EditTemplate';
    ...
    function __construct($pathModuleRoot, $viewer, $formAction, $template_id , $app_id='') 
    {
        ...
        $emailManager->setAppID( $this->app_id );  // set the current application ID
...
///        }
    ...
    function processData() 
    {
        // save the value of the Foriegn Key(s)
            $this->formValues[ 'app_id' ] = $this->app_id;
    ...
    function getHTML() 
    {
		...
		//$templateName = 'page_EditTemplate.php';
