...
$displayFields = explode( ',', $displayFieldList);
 ...
 * isDataValid
 *
 * Here we check to see if all submitted form elements are valid
 */
...
function getHTML() 
{
    ...
    $template->set( 'showFields', $displayFields);
    
    // now we get the HTML of the Template and display that for our page.
    return $template->fetch( 'ex_SeriesList_array.tpl' );
