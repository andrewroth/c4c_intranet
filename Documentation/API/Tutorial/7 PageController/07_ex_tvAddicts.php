...
require( 'page_SeasonList.php' );
require( 'page_SeriesList.php' );
require( 'page_SeriesEdit.php' );
require( 'page_SeriesAdd.php' );
require( 'page_SeriesDel.php' );
require( '07_app_tvAddicts.php' );
...
$callBack = '07_ex_tvAddicts.php?'.Page::QS_MODULE.'=Something'.$pLang;
