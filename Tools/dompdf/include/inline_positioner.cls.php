...
/* $Id: inline_positioner.cls.php,v 1.1.1.1 2006-03-20 16:51:43 russ Exp $ */
/**
...
//     pre_r("Parent: " . $p->get_node()->nodeName . " (" . (string)$p->get_node() . ")");    
    ...
    // Determine our horizontal and vertical position FIXME: account for
    // vertical align & so forth ? prolly should do vertical alignment in
    // block_reflower...
    
    $this->_frame->set_position($cb["x"] + $line["w"], $line["y"]);
//    pre_r($this->_frame->get_position());
