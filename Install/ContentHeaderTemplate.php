...
$tmp_dir="<? echo PerlFileUpload::DEF_LOCATION_TEMPDIR ?>";

$|=1;								#unbuffers streams

#$php_uploader="../php/upload2.php"; # CHANGE THIS TO YOUR PHP SCRIPTS URL

$interval=1;				  # how often to refresh the progress bar

$max_upload = <? echo PerlFileUpload::DEF_LIMIT_UPLOADSIZE ?>; # set this to whatever you feel suitable for you.
