...
var postLocation="<? echo $pathProgressBar ?>";
...
function postIt()
{
	...
	sid = document.forms[0].<? echo PerlFileUpload::DEF_QSPARAM_SID ?>.value;
	iTotal = escape("-1");
	baseUrl += "?iTotal=" + iTotal;
	baseUrl += "&iRead=0";
	baseUrl += "&iStatus=1";
	baseUrl += "&<? echo PerlFileUpload::DEF_QSPARAM_SID ?>=" + sid;
...
function postItMulti( formIndx )
{
	...
	baseUrl = postLocation;
	sid = document.forms[ formIndx ].<? echo PerlFileUpload::DEF_QSPARAM_SID ?>.value;
	iTotal = escape("-1");
	baseUrl += "?iTotal=" + iTotal;
	baseUrl += "&iRead=0";
	baseUrl += "&iStatus=1";
	...
	popUP(baseUrl,"Uploader",460,262,false,false);
	document.forms[ formIndx ].submit();
}
