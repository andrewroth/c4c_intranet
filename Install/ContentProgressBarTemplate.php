...
$query = new CGI();
$sessionid = $query->param('<? echo PerlFileUpload::DEF_QSPARAM_SID ?>');
...
sub make_url
{
	...
	##
	$url = "$thisUrl?iTotal=$iTotal&iRead=$iRead&iStatus=$status&<? echo PerlFileUpload::DEF_QSPARAM_SID ?>=$sessionid&dtnow=$dtnow&dtstart=$dtstart";
	##
	$url =~ s/\n//;
