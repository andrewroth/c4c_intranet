<?php
require_once( '../classes/class_Excel.php');
...
class  ReportSimple extends DisplayObject_MySQLDB {
// 
//  DESCRIPTION:
...
//
	...
	//************************************************************************
	function ReportSimple( $LanguageID, $Scope, $RenID ) {
...
//
		...
		// Add Report Title 
		$this->MakeTitle();
//		$this->OutputTable->AddTableCell( $this->MakeTitle(), '', DISPLAYOBJECT_TYPE_HTML, $this->NumColumns);
	...
	//
		...
		$Temp = 'Class_ReportSimple::MakeTitle This function has not been defined by your Report Site.<br>';
...
//			$this->ExcelWorkBook->AddCell( '-----------------------', '' ,$this->NumColumns - $SpacerIndx );
	...
	function ReturnFieldValue( $Key ) {
		...
		$Result = 'Class_ReportSimple::ReturnFieldValue This function has not been defined by your Report Site.<br>';
	...
	function InitGroupLookups() {
		...
		echo "Class_ReportSimple::InitGroupLookups This function has not been defined by your Report Site.<br>";	
	...
	function InitFieldLookup( ) {
		...
		echo "Class_ReportSimple::InitFieldLookups This function has not been defined by your Report Site.<br>";	
...
class  EazySummaryReport extends ReportSimple {
// 
//  DESCRIPTION:
...
//
	...
	//************************************************************************
	function EazySummaryReport( $LanguageID, $Scope, $RenID  ) {
