 ...
 */ 
/**
 * class HrdbRegionList
 * <pre> 
 * This object manages the listing of the nssren table elements.
 * </pre>
...
class  HrdbRegionList {
    ...
    const XML_NODE_NAME = 'HrdbRegionList';
    ...
    {
        $searchManager = new RowManager_HrdbRegionManager();
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_HrdbRegionManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=HrdbRegionList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_HrdbRegionManager() ) ) {
