 ...
 */ 
/**
 * class MultilingualSeriesList
 * <pre> 
 * This object manages lists of multilingual series objects.
 * </pre>
...
class  MultilingualSeriesList {
    ...
    const XML_NODE_NAME = 'MultilingualSeriesList';
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_MultilingualSeriesManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=MultilingualSeriesList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_MultilingualSeriesManager() ) ) {
