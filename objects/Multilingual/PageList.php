 ...
 * <pre> 
 * This class manages lists of multilingual Pages.
 * </pre>
...
class  MultilingualPageList {
    ...
    const XML_NODE_NAME = 'MultilingualPageList';
    ...
    function getNext() 
    {
        return $this->resultSet->getNext( new RowManager_MultilingualPageManager() );
    }  // end classMethod()
	 ...
	 */
	function getXML( $isHeaderIncluded=true, $rootNodeName=MultilingualPageList::XML_NODE_NAME ) 
	{
        $xmlObject = new XMLObject( $rootNodeName);
        
        $this->resultSet->setFirst();
        while( $item = $this->resultSet->getNext( new RowManager_MultilingualPageManager() ) ) {
